...
\begin{align*}
    ...
    for epoch in np.arange(0,epochs):
        ...
        \begin{quote}
            \blockquote[Burke, 2002]{A recommender system is any system that produces indiviudalized recommendations as output or has the effect of guiding the user in a personalized way to interesting or useful objects in a large space of possible options}
        \end{quote}

        Or easier said:

        \begin{quote}
            \blockquote[Jennach et. al., 2010]{A recommender system is a software application capable of suggesting interesing things to its users after learning their preferences over time}
        \end{quote}
        ...
        As opposed to Support or Lift, recommender systems are \textbf{indiviudalized}.
        ...
        Beause user proviles constantly change, pre-computation does not necessarily work. In contrast, for pairs fo items, similarity is stable and can be pre-computed.
        ...
        Advantages of Collaborative Fiiltering Recommendations
        ...
        The second matrix (V) holds all the products and the rating they've gotten. This matrix is \textbf{transposed}. o

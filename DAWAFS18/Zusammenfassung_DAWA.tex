...
\begin{enumerate}
	...
	\begin{figure}[htb!]
		\centering
		\includegraphics[keepaspectratio=true,height=10\baselineskip]{neuer_Datenspeicher.PNG}
	\end{figure}
	\item Als Datenplattform und zusätzlicher Input für das Enterprise Data Warehouse
	\begin{figure}[htb!]
		\centering
		\includegraphics[keepaspectratio=true,height=10\baselineskip]{datei_plattform.PNG}
	\end{figure}
	\item Als Daten Plattform und Basis für BI und Analytics
	\begin{figure}[htb!]
		\centering
		\includegraphics[keepaspectratio=true,height=10\baselineskip]{datei_plattform_2.PNG}
	\end{figure}
\end{enumerate}
...
\subsection{Möglichkeiten von Hadoop}

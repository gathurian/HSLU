...
\begin{wrapfigure}[15]{L}{0.5\textwidth}
	\centering
	\includegraphics[keepaspectratio=true,height=13\baselineskip]{HubAndSpoke.PNG}
...
\begin{wrapfigure}[17]{R}{0.45\textwidth}
	\centering
	\includegraphics[keepaspectratio=true,height=13\baselineskip]{starschema.jpg}
...
\begin{wrapfigure}[9]{L}{0.5\textwidth}
	\centering
	\includegraphics[keepaspectratio=true,height=12\baselineskip]{snowflake.PNG}
	\caption{caption}
	\label{label}
\end{wrapfigure}
...
\begin{wrapfigure}[16]{R}{0.5\textwidth}
	\centering
	\includegraphics[keepaspectratio=true,height=12\baselineskip]{galaxy.PNG}
...
Sie in Abbildung \ref{fig:star} zu sehen ist, enthalten Faktentabellen Fremdschlüssel zu den Einträgen in den Dimensionstabellen. Das impliziert, dass es jeden Eintrag zu einer Kombination von Dimensionen nur einmal geben kann.
...
\subsubsection{Data Mining (Skript S71)}
...
\subsubsection{Text Mining (Skript S71)}
